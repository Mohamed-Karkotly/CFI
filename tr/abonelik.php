...
<body>
	...
	if (isset($_POST['submit'])) {
		...
		$message = "Here's the Subscriber's e-mail from the turkish version: >>" . "\n\n" . $email;
		...
		<div class=\"main-content\">
			...
			<p class=\"main-content__body\" data-lead-id=\"main-content-body\">Bunu doldurduğun için çok teşekkürler. Tıpkı sizin gibi bizim için çok şey ifade ediyor! Bugün bize zaman ayırdığınız için gerçekten minnettarız. Sen olduğun için teşekkürler.</p>
			<hr>
