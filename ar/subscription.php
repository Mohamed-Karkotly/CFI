...
<body>
	...
	if (isset($_POST['submit'])) {
		...
		$subject = 'مشترك جديد من الموقع';
		$message = ":إليك ايميل المشترك" . "<br>" . $email;
		...
		<div class=\"main-content\">
			...
			<p class=\"main-content__body\" data-lead-id=\"main-content-body\">شكراً للاشتراك في جريدتنا الشهرية، سوف نوافيك بأحدث المستجدات، وسنقوم بالتواصل معك قريباً!</p>
			<hr>
			<a href=\"home.html\" class=\"main-filled-button3\">الرجوع للصفحة الرئيسية</a>
		</div>
		...
		<div class=\"main-content\">
			...
			<p>يبدو أن هناك خطأً حدث بشكل غير متعمد، يرجى الرجوع للصفحة السابقة وإعادة التسجيل مجدداً.</p>
			<a href=\"home.html\" class=\"main-filled-button3\">الرجوع للصفحة الرئيسية</a>
		</div>
